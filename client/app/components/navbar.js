        ...
        <ul className="navbar-form navbar-right">
          <div className="dropdown">
            ...
            <div className="dropdown-menu" aria-labelledby="dropdownMenuButton">
              <li><Link to={"/profile/000000000000000000000001"}>My Profile</Link></li>
              <li><Link to={"/team/000000000000000000000001"}>Team Awesome</Link></li>
              <li><Link to={"/team/000000000000000000000003"}>Team Fun</Link></li>
